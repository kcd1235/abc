...
<content>
	<form method="post" action=MemberJoin.do>  
		<table border = 1 width=500px >
			<caption>회원기본정보<font size=2px color=gray>(*는 필수 입력 항목입니다)</font></caption>
			<tbody>
				<tr>
					<td class="c1">아이디*</td>
					<td>
						<input type="text" id="userid" name="userid" placeholder="아이디 입력" required> 
						<a href="#"><input type=button value=중복확인></a>
					</td>
				</tr>
				<tr>
					<td class="c1">비밀번호*</td>
				...
				<tr>
					...
					<td>
						...
						- 
						<input type="tel" size=5px name="ph3" placeholder="****" pattern=[0-9]{4} required>
					</td>
				</tr>
				<tr>
					<td class="c1">이메일</td>
				...
				<tr>
					<td class="c1">우편번호*</td>
					<td>
						<input type="text" name=zipcode required >&nbsp;<a href="#">
						<input type=button value=주소찾기></a>
					</td>
				</tr>
				<tr>
					<td class="c1">기본주소*</td>
